...
class Sensor:
    ...
    def GetSensorData(self,car_size, car_angle, car_pos):
        ...
        for z in range(self.num_of_sensors):
            ...
            data.append(self.Distance(top_right_pt,road_point))
            ...
            data.append(self.Distance(top_left_pt,road_point))
            ...
            data.append(self.Distance(bot_right_pt,road_point))
            ...
            data.append(self.Distance(bot_left_pt,road_point))
